var JSErrorCollector = {
	...
	consol: function() {
		...
		{ 
			JSErrorCollector.push(arguments); 
	...
	initialize: function() {
		...
		script.textContent = 'console.log("tere"); var loggs = []; var oldf = console.log; console.log = function() { loggs.push(arguments); oldf.apply(console, arguments); };';
		script.async = false;
